...
//    private PredictionThread predictionThread;// Thread where tensorflow prediction is processed
    ...
    public void onCameraViewStarted(int previewWidth, int previewHeight, boolean rotated, int cameraIndex) {
        Log.e("CarLicenseRecog", "JNI : CameraView Started");
        ...
        LOGGER.i("RecogApp", "Initializing at size %dx%d", previewWidth, previewHeight);
        Log.e("CarLicenseRecog", "JNI : Initializing at size %dx%d" + previewWidth + "  " +  previewHeight);
